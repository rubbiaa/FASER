...
CustomCharmDecay::CustomCharmDecay()
   : G4VExtDecayer("CustomCharmDecay")
{
...
G4DecayProducts* CustomCharmDecay::ImportDecayProducts(const G4Track& track)
{

    G4cout << "CustomCharmDecay ImportDecayProducts" << G4endl;
