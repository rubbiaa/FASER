...
void ESstudy(const char* filename="FASERMC-PO-Run500-0_99261.root", Long64_t maxEvents=5, bool full=true, const char* filterReactions="") {
    ...
    std::cout << filterReactions << std::endl;
	...
	if(event->isES()||event->event_id==850335||event->event_id==56451||event->event_id==288574||event->event_id==288574){
