...
#pragma link C++ struct TPORec::TRACKHIT+;
#pragma link C++ struct TPORec::TRACK+;
...
#pragma link C++ class TPSCluster::PSCLUSTERHIT+;
#pragma link C++ class TPSCluster::PSCLUSTERLONGPROFILE+;
#pragma link C++ class TPSTrack+;
#pragma link C++ class TPSTrack::TRACKHIT+;
#pragma link C++ class TTauSearch+;
#pragma link C++ class TTauSearch::KINEMATICS+;
#pragma link C++ class TTKTrack+;
#pragma link C++ class TTKTrack::TRACKHIT+;
